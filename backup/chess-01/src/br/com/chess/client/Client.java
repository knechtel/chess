	...
	public Client() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null,
					"Porta só aceita numeros inteiros! (Ex. 8082)");
			System.exit(1);
		}
		...
		try {
			...
			// envia o nome da maquina na rede (para reconhecer quem é o
			// verdadeiro usuario)
			...
			JOptionPane.showMessageDialog(null, "Não encontrou o servidor: "
					+ host + ":" + port + ".");
			System.exit(1);
		} catch (IOException e) {
			JOptionPane
					.showMessageDialog(null, "Não conseguiu conexão I/O com: "
							+ host + ":" + port + ".");
			System.exit(1);
		} catch (Exception e) {
			e.printStackTrace();
		...
		System.out
				.println("Conexão com sucesso em " + host + ":" + port + " !");
			...
			public synchronized void run() {
				...
				while (true) {
					try {
						...
						// verifica se a lista de peças para promoçao é nula
						if (p.isBlack()) {
